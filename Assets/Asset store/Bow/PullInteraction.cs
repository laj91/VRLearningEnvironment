...
public class PullInteraction : XRBaseInteractable
{
    ...
    //    {
    //        ActionBasedController currenController = pullingInteractor.transform.gameObject.GetComponent<ActionBasedController>();
    //        currenController.SendHapticImpulse(pullAmount, .1f);
    //    }
    //}
}